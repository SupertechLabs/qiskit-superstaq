...
def test_circuit_serialization() -> None:
    ...
    circuit_1.append(qiskit_superstaq.AQTiCCXGate(ctrl_state="00"), [0, 1, 2])
    circuit_1.append(qiskit_superstaq.AQTiCCXGate(ctrl_state="01"), [1, 0, 2])
    circuit_1.append(qiskit_superstaq.AQTiCCXGate(ctrl_state="10"), [2, 1, 0])
